...
static const s8 sAiAbilityRatings[ABILITIES_COUNT] =
{
    ...
    [ABILITY_EVENT_HORIZON] = 10,
    [ABILITY_FASTER_THAN_LIGHT] = 6,
    [ABILITY_ASTEROID_BELT] = 7,
    [ABILITY_ANOMALY] = 4,
};
...
s32 AI_DecideKnownAbilityForTurn(u32 battlerId)
{
    ...
    if (knownAbility == ABILITY_SHADOW_TAG || knownAbility == ABILITY_MAGNET_PULL || knownAbility == ABILITY_ARENA_TRAP || knownAbility == ABILITY_EVENT_HORIZON)
        return knownAbility;
