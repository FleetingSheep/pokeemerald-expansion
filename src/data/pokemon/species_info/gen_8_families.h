...
const struct SpeciesInfo gSpeciesInfoGen8[] =
{
    ...
    [SPECIES_IMPIDIMP] =
    {
        ...
        .abilities = { ABILITY_PRANKSTER, ABILITY_COMEDIAN, ABILITY_PICKPOCKET },
        .bodyColor = BODY_COLOR_PINK,
...
#define ALCREMIE_REGULAR_SPECIES_INFO(sweet, cream, color)                                      \
    ...
    [SPECIES_CUFANT] =
    {
        ...
        .abilities = { ABILITY_SHEER_FORCE, ABILITY_NONE, ABILITY_HYPERDENSITY },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_DURALUDON] =
    {
        ...
        .abilities = { ABILITY_LIGHT_METAL, ABILITY_HYPERDENSITY, ABILITY_STALWART },
        .bodyColor = BODY_COLOR_WHITE,
