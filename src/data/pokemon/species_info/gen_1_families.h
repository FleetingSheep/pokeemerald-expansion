...
#define PIDGEOT_SPEED (P_UPDATED_STATS >= GEN_6 ? 101 : 91)
    ...
    [SPECIES_PICHU] =
    {
        ...
        .abilities = { ABILITY_STATIC, ABILITY_LIGHTNING_ROD, ABILITY_FASTER_THAN_LIGHT },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Pichu"),
        .cryId = CRY_PICHU,
...
#define GENGAR_ABILITIES {ABILITY_LEVITATE, ABILITY_NONE, ABILITY_NONE}
    ...
    [SPECIES_STEELIX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_HYPERDENSITY, ABILITY_STURDY, ABILITY_SHEER_FORCE },
        .bodyColor = BODY_COLOR_GRAY,
...
#define EXEGGUTOR_SP_DEF (P_UPDATED_STATS >= GEN_7 ? 75 : 65)
    ...
    [SPECIES_SCYTHER] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_STEADFAST, ABILITY_TECHNICIAN, ABILITY_FASTER_THAN_LIGHT },
    #else
        .abilities = { ABILITY_STEADFAST, ABILITY_NONE, ABILITY_FASTER_THAN_LIGHT },
    #endif
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_PORYGON_Z] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_ANOMALY, ABILITY_DOWNLOAD, ABILITY_ADAPTABILITY },
        .bodyColor = BODY_COLOR_RED,
