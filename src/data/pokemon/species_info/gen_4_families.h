...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_KRICKETOT] =
    {
        ...
        .abilities = { ABILITY_SHED_SKIN, ABILITY_COMEDIAN, ABILITY_RUN_AWAY },
    ...
    [SPECIES_KRICKETUNE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SWARM, ABILITY_COMEDIAN, ABILITY_TECHNICIAN },
        .bodyColor = BODY_COLOR_RED,
...
#define MOTHIM_SPECIES_INFO                                                 \
    ...
    [SPECIES_CHATOT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_KEEN_EYE, ABILITY_COMEDIAN, ABILITY_BIG_PECKS },
    ...
    [SPECIES_SPIRITOMB] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_ANOMALY, ABILITY_NONE, ABILITY_INFILTRATOR },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_PALKIA] =
    {
        ...
        .baseSpAttack  = 150,
        .baseSpDefense = 120,
        .types = MON_TYPES(TYPE_SPACE, TYPE_DRAGON),
        .catchRate = 3,
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PRESSURE, ABILITY_NONE, ABILITY_PERIAPSIS },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_GIRATINA_ALTERED] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PRESSURE, ABILITY_NONE, ABILITY_EVENT_HORIZON },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_CRESSELIA] =
    {
        ...
        .types = MON_TYPES(TYPE_PSYCHIC, TYPE_SPACE),
        .catchRate = 3,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 300,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_DARKRAI] =
    {
        ...
        .baseSpAttack  = 135,
        .baseSpDefense = 90,
        .types = MON_TYPES(TYPE_DARK, TYPE_SPACE),
        .catchRate = 3,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 300,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
...
#define ARCEUS_SPECIES_INFO(type, typeName, iconPal)                        \
    {                                                                       \
        ...
        .growthRate = GROWTH_SLOW,                                          \
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),          \
        .abilities = { ABILITY_MULTITYPE, ABILITY_NONE, ABILITY_LIMITLESS },\
        .bodyColor = BODY_COLOR_WHITE,                                      \
