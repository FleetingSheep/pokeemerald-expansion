...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_LEDYBA] =
    {
        ...
        .abilities = { ABILITY_FASTER_THAN_LIGHT, ABILITY_SWARM, ABILITY_RATTLED },
    ...
    [SPECIES_LEDIAN] =
    {
        ...
        .baseSpAttack  = 55,
        .baseSpDefense = 110,
        .types = MON_TYPES(TYPE_BUG, TYPE_SPACE),
        .catchRate = 90,
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_FASTER_THAN_LIGHT, ABILITY_SWARM, ABILITY_IRON_FIST },
        .bodyColor = BODY_COLOR_RED,
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_HERACROSS] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_LIMITLESS, ABILITY_GUTS, ABILITY_MOXIE },
        .bodyColor = BODY_COLOR_BLUE,
