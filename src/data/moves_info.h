...
const struct MoveInfo gMovesInfo[MOVES_COUNT_DYNAMAX] =
{
    ...
    [MOVE_SOLAR_FLARE] =  // burns and boost in sunny day, flamethrower equivalent
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_SUNNY_DAY},
        .battleAnimScript = Move_SOLAR_FLARE,
    },
    [MOVE_LUMINOSITY] =  // special buffs and self applied burn
    {
        .name = COMPOUND_STRING("Luminosity"),
        .description = COMPOUND_STRING(
            "Radiates burning light,\n"
            "raising Sp.Atk and Speed."),
    ...
    [MOVE_WORMHOLE] =  // priority move or phantom force?
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = Move_WORMHOLE,
    ...
    {
        .name = COMPOUND_STRING("Asteroid Toss"),
        .description = COMPOUND_STRING(
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_LEER},
        .battleAnimScript = Move_ASTEROID_TOSS,
    
    },
    [MOVE_RELATIVITY] =  // deals damage depending on speed difference between user and target
    {
        .name = COMPOUND_STRING("Relativity"),
        .description = COMPOUND_STRING(
            "Strikes harder the larger\n"
            "the gap in speed."),
        .effect = EFFECT_HIT,
        .power = 1,
        .type = TYPE_SPACE,
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = Move_RELATIVITY,
    ...
    [MOVE_IMPACT_EVENT] =  // high recoil move
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_FOCUS_ENERGY, COMBO_STARTER_HARDEN},
        .battleAnimScript = Move_IMPACT_EVENT,
    },
    [MOVE_RED_SHIFT] =
    {
        .name = COMPOUND_STRING("Red Shift"),
        .description = COMPOUND_STRING(
            "Alters perception of space,\n"
            "disorienting the target."),
        .effect = EFFECT_RED_SHIFT, // change later? secondary effects system seems to accomodate this
        .power = 0,
        .type = TYPE_SPACE,
        .accuracy = 70,
        .pp = 10,
