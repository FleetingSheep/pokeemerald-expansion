...
gBattleScriptsForMoveEffects::
	...
	.4byte BattleScript_EffectSupernova				  @ EFFECT_SUPERNOVA
	.4byte BattleScript_EffectSolarFlare       		  @ EFFECT_SOLAR_FLARE
	.4byte BattleScript_EffectLuminosity			  @ EFFECT_LUMINOSITY
	.4byte BattleScript_EffectHit			  		  @ EFFECT_RELATIVITY
	.4byte BattleScript_EffectRedShift				  @ EFFECT_RED_SHIFT
=======
...
BattleScript_PeriapsisActivates::
	pause B_WAIT_TIME_SHORT
	call BattleScript_AbilityPopUp
	waitstate
	playanimation BS_SCRIPTING, B_ANIM_RESTORE_BG
	call BattleScript_EffectPeriapsis
	end3
...
BattleScript_SupernovaAnimRet:
	attackanimation
	waitanimation
BattleScript_SupernovaDmgRet:
	movevaluescleanup
	critcalc
	damagecalc
	adjustdamage
	accuracycheck BattleScript_SupernovaMissedRet, ACC_CURR_MOVE
	effectivenesssound
	hitanimation BS_TARGET
	waitstate
	healthbarupdate BS_TARGET
	...
	waitmessage B_WAIT_TIME_LONG
	tryfaintmon BS_TARGET
BattleScript_SupernovaAnimEndRet_Return:
	return
BattleScript_SupernovaMissedRet:
	effectivenesssound
	resultmessage
	waitmessage B_WAIT_TIME_LONG
	goto BattleScript_SupernovaAnimEndRet_Return

BattleScript_EffectSupernova::
	attackcanceler
	attackstring
	ppreduce

BattleScript_EffectSupernova_AnimDmgFaintAttacker:
	call BattleScript_EffectSupernova_AnimDmgRet
	moveendall
	sethptoone
	healthbarupdate BS_ATTACKER
	datahpupdate BS_ATTACKER
...
BattleScript_EffectLuminosity::
	attackcanceler
	attackstring
	jumpifstat BS_ATTACKER, CMP_LESS_THAN, STAT_SPATK, MAX_STAT_STAGE, BattleScript_LuminosityDoMove
	jumpifstat BS_ATTACKER, CMP_LESS_THAN, STAT_SPEED, MAX_STAT_STAGE, BattleScript_LuminosityDoMove
BattleScript_LuminosityDoMove:
	ppreduce
	attackanimation
	waitanimation
	setbyte sSTAT_ANIM_PLAYED, FALSE
	...
	setstatchanger STAT_SPATK, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR, BattleScript_LuminosityTrySpe
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_INCREASE, BattleScript_LuminosityTrySpe
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_LuminosityTrySpe:
	setstatchanger STAT_SPEED, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR, BattleScript_LuminosityDoBurn
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_INCREASE, BattleScript_LuminosityDoBurn
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_LuminosityDoBurn:
	jumpifstatus BS_ATTACKER, STATUS1_BURN, BattleScript_MoveEnd
	setmoveeffect MOVE_EFFECT_BURN
	seteffectprimary
	goto BattleScript_MoveEnd
...
BattleScript_EffectRedShift::
	...
	printfromtable gStatDownStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_RedShiftTryConfuse:
	jumpifability BS_TARGET, ABILITY_OWN_TEMPO, BattleScript_OwnTempoPrevents
	jumpifsafeguard BattleScript_SafeguardProtected
