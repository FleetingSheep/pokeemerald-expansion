...
#define METATILE_BikeShop_Mauville_Block           0x2A0
#define METATILE_BikeShop_Mauville_Closed_Doors    0x290
#define METATILE_BikeShop_Mauville_Upper_Block     0x298
...
#define METATILE_Fallarbor_BOTTOM_BROWN_ROCK_WALL    0x264
